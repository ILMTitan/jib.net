...
class PullAndCacheBaseImageLayersStep
    implements Callable<ImmutableList<PullAndCacheBaseImageLayerStep>> {
  ...
  private final Future<BaseImageWithAuthorization> baseImageWithAuthorization;
  ...
  PullAndCacheBaseImageLayersStep(
    ...
    this.baseImageWithAuthorization = baseImageWithAuthorization;
  }

  @Override
  public ImmutableList<PullAndCacheBaseImageLayerStep> call()
      throws InterruptedException, ExecutionException {
    ImmutableList<Layer> baseImageLayers =
        baseImageWithAuthorization.get().getBaseImage().getLayers();
    ...
    try (ProgressEventDispatcher progressEventDispatcher =
      ...
      ImmutableList.Builder<PullAndCacheBaseImageLayerStep> layerPullers =
      ...
      for (Layer layer : baseImageLayers) {
        layerPullers.add(
            new PullAndCacheBaseImageLayerStep(
                ...
                baseImageWithAuthorization.get().getBaseImageAuthorization()));
      }
      return layerPullers.build();
    }
  }
}
